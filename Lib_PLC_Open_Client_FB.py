...
def logTestDetails() -> Callable:
    ...
    def decorator(func : Callable) -> Callable:
        ...
        def wrapper(self, *args, **kwargs) -> List[bool]:
            ...
            self.logTestDescription(result = testResults)

            testResults = func(self, *args, **kwargs)

            self.saveTestResult(result = testResults, remark = self.remarks)
...
class Lib_PLC_Open_Client_FB(Lib_Base):
    ...
    def execute_Grp1(self):
        ...
        testResult, testRemarks = self.__execute_Grp(testType = constants.TestType.INTERNAL.value)
    ...
    def execute_Grp2(self):
        ...
        testResult, testRemarks = self.__execute_Grp(testType = constants.TestType.EXTERNAL.value)
        return testResult, testRemarks
    ...
    def execute_Grp5(self):
        ...
        testResult, testRemarks = self.__execute_Grp(testType = constants.TestType.MULTIPLE.value)
        return testResult, testRemarks
